...
class CreateFeederDataKurikulumsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('feeder_data_kurikulums', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('feeder_data_kurikulums');
    }
}
