...
class CreateFeederDataMataKuliahsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('feeder_data_mata_kuliahs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('feeder_data_mata_kuliahs');
    }
}
